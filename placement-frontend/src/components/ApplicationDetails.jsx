...
function ApplicationDetails(){
    ...
    const handleApply=e=>{
        axios.post("http://localhost:9090/api/students/apply",data?.job)
        .then(resp=>{
    ...
    const handleUpdate=(status)=>{
        info.status=status
        console.log(info)
        axios.post("http://localhost:9090/api/company/applications/update",info)
        .then(resp=>{
    ...
    useEffect(()=>{
        axios.get("http://localhost:9090/api/company/applications/details/"+aid)
        .then(resp=>{
                    ...
                    <div className="card shadow">
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <img src={"http://localhost:9090/"+data?.student?.photo} className="img-thumbnail float-left" />                        
                                </div>
