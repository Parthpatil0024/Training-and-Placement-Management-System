...
function UploadStudentInfo(){
    ...
    useEffect(()=>{
        axios.get("http://localhost:9090/api/students/"+cid)
        .then(resp=>{
    ...
    const downloadResume = id=>{
        ...
        window.location.href="http://localhost:9090/"+user?.resume;
    }
    ...
    const handleSubmit=(e)=>{
        ...
        if(Object.keys(errors).length===0){
            ...
            axios.post("http://localhost:9090/api/students/upload",formData)
            .then(resp=>{
                console.log(resp)
                setUser(null)
                e.target.reset()
                ...
                <div className="row">                    
                    <div className="col-sm-6 mx-auto">
                        ...
                        <div className="form-group form-row">
                            ...
                            <div className="col-sm-8">
                                <input type="number" name="xthpercent" value={user?.xthpercent} min="1" max="100" onChange={handleInput} className="form-control form-control-sm" />
                        ...
                        <div className="form-group form-row">
                            ...
                            <div className="col-sm-8">
                                <input type="number" name="xiithpercent" value={user?.xiithpercent} onChange={handleInput} min="1" max="100"  className="form-control form-control-sm" />
